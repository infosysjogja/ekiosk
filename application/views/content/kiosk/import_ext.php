<div class="rms-form-wizard">
   <!--Wizard Step Navigation Start-->
	...
	<form name="form-rms-wizard" id="form-rms-wizard" action="<?php echo site_url('kiosk/execute_import_ext'); ?>" autocomplete="off" url="submit" onsubmit="return false;">
			...
			<div class="rms-content-area">
				...
				<div class="rms-content-body"> 
					<div class="row">
						...
						<label class="col-md-2 control-label margin-top-10">PAIDTHROUGH</label>
						<div class="col-md-4">
							<div class="inpt-form-group">
								<div class="inpt-group">
									<input type="text" name="tgl_tempo" id="tgl_tempo" class="inpt-control date" placeholder="PAIDTHROUGH TERAKHIR" mandatory="yes">
								</div> 
							</div>
						</div>
					</div>
					<div class="row">
						...
						<label class="col-md-2 control-label margin-top-10">PERPANJANGAN</label>
						<div class="col-md-4">
							<div class="inpt-form-group">
								<div class="inpt-group">
									<input type="text" name="date_until" id="date_until" class="inpt-control datedefault" placeholder="PERPANJANGAN S/D" mandatory="yes">
								</div> 
							</div>
						</div>
					</div>
