		...
		<table class="tabelajax-no-border-left" width="100%">
			<tbody>
				...
				<tr>
					...
					<td>:</td>
					<td class="desc-val"><?php echo ($arrhdr['vessel_name']!="")?$arrhdr['vessel_name']." - ".$arrhdr['voyage_in']." / ".$arrhdr['voyage_out']:""; ?></td> 
				</tr>
				<tr>
					<td class="desc-label">VIA / TRANSIT</td>
					<td>:</td>
					<td class="desc-val"><?php echo $arrhdr['spod']." - ".port_name($arrhdr['spod']); ?></td>
				</tr>
				<tr>
					<td class="desc-label">TUJUAN</td>
					<td>:</td>
					<td class="desc-val"><?php echo $arrhdr['pod']." - ".port_name($arrhdr['pod']); ?></td>
				</tr>
				<tr>
				...
				<tr>
					<td class="desc-label">PAIDTHROUGH / PERPANJANGAN S/D</td>
					<td>:</td>
					<td class="desc-val"><?php echo $this->input->post('tgl_tempo')." / ".$this->input->post('date_until'); ?></td>
				</tr>
				<tr>
					<td class="desc-label">CATATAN</td>
					<td>:</td>
					<td class="desc-val"><code style="font-size:18px">Dengan melakukan pengajuan ini, maka gatepass yang sebelumnya tidak akan berlaku lagi.</code></td>
				</tr>
			</tbody>
		</table>
	</div>
